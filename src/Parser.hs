...
getBinaryOperatorPrecedence TokenPercent = pure(75)
getBinaryOperatorPrecedence TokenPlus = pure(70)
getBinaryOperatorPrecedence TokenMinus = pure(70)
getBinaryOperatorPrecedence TokenDoubleGreaterThan = pure(65)
getBinaryOperatorPrecedence TokenDoubleLessThan = pure(65)
...
getBinaryOperatorPrecedence TokenAmpersand = pure(45)
getBinaryOperatorPrecedence TokenPipe = pure(40)
getBinaryOperatorPrecedence TokenCaret = pure(35)
...
getBinaryOperatorPrecedence TokenPercentEqual = pure(20)
getBinaryOperatorPrecedence TokenAmpersandEqual = pure(20)
getBinaryOperatorPrecedence TokenPipeEqual = pure(20)
getBinaryOperatorPrecedence TokenCaretEqual = pure(20)
getBinaryOperatorPrecedence TokenDoubleGreaterThanEqual = pure(20)
getBinaryOperatorPrecedence TokenDoubleLessThanEqual = pure(20)
...
getBinaryOperator TokenPercent = pure(BinaryRem)
getBinaryOperator TokenPlus = pure(BinaryAdd)
getBinaryOperator TokenMinus = pure(BinarySub)
getBinaryOperator TokenDoubleGreaterThan = pure(ShiftRight)
getBinaryOperator TokenDoubleLessThan = pure(ShiftLeft)
...
getBinaryOperator TokenAmpersand = pure(BinaryAnd)
getBinaryOperator TokenPipe = pure(BinaryOr)
getBinaryOperator TokenCaret = pure(BinaryXor)
...
getBinaryOperator TokenPercentEqual = pure(BinaryCompound)
getBinaryOperator TokenAmpersandEqual = pure(BinaryCompound)
getBinaryOperator TokenPipeEqual = pure(BinaryCompound)
getBinaryOperator TokenCaretEqual = pure(BinaryCompound)
getBinaryOperator TokenDoubleGreaterThanEqual = pure(BinaryCompound)
getBinaryOperator TokenDoubleLessThanEqual = pure(BinaryCompound)
...
getBinaryCompoundOperator TokenPercentEqual = pure(BinaryRem)
getBinaryCompoundOperator TokenAmpersandEqual = pure(BinaryAnd)
getBinaryCompoundOperator TokenPipeEqual = pure(BinaryOr)
getBinaryCompoundOperator TokenCaretEqual = pure(BinaryXor)
getBinaryCompoundOperator TokenDoubleGreaterThanEqual = pure(ShiftRight)
getBinaryCompoundOperator TokenDoubleLessThanEqual = pure(ShiftLeft)
...
getPrefixUnaryOperatorPrecedence TokenTilde = pure(85)
...
getPrefixUnaryOperator TokenTilde = pure(UnaryNot)
